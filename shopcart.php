...
<?php   
 session_start();  
 $connect = mysqli_connect("localhost", "root", "rootpasswordgiven", "mydb");  
 ?>  
 <!DOCTYPE html>  
 <html>  
      <head>  
...
<!-- HEADER -->
	<header>
		...
		<nav>
			...
			<li>
				<a href="LoginAcc.html" class="active">Login</a>
			</li>
	...
	<!-- END OF HEADER -->
           ...
           <div class="container" style="width:800px;">  
                <h3 style="color:gold" align="center">Menu Items</h3><br />  
                ...
                <div class="tab-content">  
                     ...
                     <div class="col-md-4" style="margin-top:12px;">  
                          <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px; height:400px;" align="center">  
                               ...
                               <h5 class="text-info"><?php echo $row["name"]; ?></h4>  
                               <h5 class="text-danger">Rs. <?php echo $row["price"]; ?></h4>  
