 ...
 {  
      ...
      $order_table .= '  
           ...
           <table  style="background-color:white" class="table table-bordered" >  
                <tr >  
                     <th style="color:black" width="40%">Product Name</th>  
                     <th style="color:black" width="10%">Quantity</th>  
                     <th style="color:black" width="20%">Price</th>  
                     <th style="color:black" width="15%">Total</th>  
                     <th style="color:black" width="5%">Action</th>  
                </tr>  
           ';  
